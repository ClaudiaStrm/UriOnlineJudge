...
isenta de Imposto de Renda. No exemplo fornecido (abaixo), a taxa é de 8% 
...
if sal <= 2000:
	...
	print("R$ %.2f" %((sal - 2000) * 8 / 100))
elif 3000 < sal <= 4500: 
	print("R$ %.2f" %(((sal - 3000) * 18 / 100) + 80))
else: 
	print("R$ %.2f" %(((sal - 4500) * 28 / 100) + 80 + 270))